...
def get_raw_skes_data(ske_name):
    ...
    raw_skes_data = [bodies_data]
    frames_cnt = np.array([bodies_data['num_frames']])
...
if __name__ == '__main__':
    ...
    ske_name = 'S001C001P001R001A001'  # Replace with your skeleton file name
    ...
    frames_drop_skes = dict()  # Define frames_drop_skes as a global variable

    get_raw_skes_data(ske_name)
