...
if __name__ == "__main__":
    ...
    output_file_path = r"C:\Users\cyh23\Desktop\论文复现\HD-GCN-main\pre-processing\statistics\camera.txt" # 请替换为您想要的输出路径
    bvh_files = count_bvh_files(target_directory)
    camera_numbers = assign_random_camera_numbers(bvh_files)
    save_to_camera_txt(bvh_files, camera_numbers, output_file_path)
    print(f"{output_file_path} 文件已生成。")
